...
def payments(request):
    ...
    # send the order received email to customer
...
def place_order(request, total=0, quantity=0,):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            data.is_ordered = False  # Add this line to ensure the field is set
            data.save()
            print("Order saved with ID:", data.id)  # Debugging statement
            # generate order no. 
